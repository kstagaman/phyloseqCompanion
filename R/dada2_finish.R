...
#'@paired Logical. Are these paired sequence data? Default is TRUE.
#'@force Logical. By default the pipeline will skip steps if their corresponding output objects already exist. Set to TRUE to force the pipeline to run through all steps. Default is FALSE.
